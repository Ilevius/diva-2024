            ...
            if (field == "upp") then
                ...
                if (mode == "freqs") then
                    do i = 1, pointsNumber
                        ...
                        call ups_stPhase(1, psis, Rs, kappa, kappaCap, lambda(1), lambda(2), mu(1), mu(2), stPhase(:,i))  
                     enddo   
                else
...
!                                                                     || ||  \\  ||_//
 !                                                                    \\_// \_)) ||   
        ...
        ! obtaining asymptotics 
                ...
                theResult(1,i) = commonRes*(-sigmaCap(2)) ! поставил минус перед sigmaCap(2) 03-05-2024
                theResult(2,i) = commonRes*(-ci*alfa0)    
            enddo      
