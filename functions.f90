...
!                    _______  _______  _______  _        _______  _______ _________ _______  ______  
...
!                   |/   \__/(_______/|/       (_______/(_______/(_______/   )_(   (_______/(______/ 
!                                                                                
!                                                                         __ __ ____   __ 
!                                                                         || || || \\ (( \
!                                                                         || || ||_//  \\ 
...
!                                                                     || ||  \\  ||_//
 !                                                                    \\_// \_)) ||       
        ...
        FUNCTION EtaSP(alfa, h, R, kappa, kappaCap, psi)
            ...
            real*8 alfa, h, R, kappa(2), kappaCap(2), psi
            real*8  EtaSP   
                EtaSP = (sqrt(kappa(2)**2-alfa**2)+sqrt(kappaCap(1)**2-alfa**2))*h/R-sqrt(kappaCap(1)**2-alfa**2)*sind(psi)-alfa*cosd(psi)            
        END FUNCTION EtaSP
        ...
        FUNCTION DEtaSP(alfa, h, R, kappa, kappaCap, psi)
            ...
            real*8 alfa, h, R, kappa(2), kappaCap(2), psi
            real*8  DEtaSP   
                DEtaSP = h*alfa*sqrt(kappaCap(1)**2-alfa**2)+h*alfa*sqrt(kappa(2)**2-alfa**2)-R*alfa*sind(psi)*sqrt(kappa(2)**2-alfa**2)
                DEtaSP = DEtaSP + R*cosd(psi)*sqrt(kappaCap(1)**2-alfa**2)*sqrt(kappa(2)**2-alfa**2)
        END FUNCTION DEtaSP
        ...
        FUNCTION D2EtaSP(alfa, h, R, kappa, kappaCap, psi)
            ...
            real*8  D2EtaSP, den1, den2
                ...
                D2EtaSP = kappaCap(1)**2*sind(psi)/den1 - h/R*kappaCap(1)**2/den1 - h/R*kappa(2)**2/den2
...
!                                                                         \\_// ||    \_))
        ...
        FUNCTION EtaPS(alfa, h, R, kappa, kappaCap, psi)
            ...
            real*8 alfa, h, R, kappa(2), kappaCap(2), psi
            real*8  EtaPS   
                EtaPS = (sqrt(kappa(1)**2-alfa**2)+sqrt(kappaCap(2)**2-alfa**2))*h/R-sqrt(kappaCap(2)**2-alfa**2)*sind(psi)-alfa*cosd(psi)            
        END FUNCTION EtaPS
        ...
        FUNCTION DEtaPS(alfa, h, R, kappa, kappaCap, psi)
            ...
            real*8 alfa, h, R, kappa(2), kappaCap(2), psi
            real*8  DEtaPS   
                DEtaPS = h*alfa*sqrt(kappaCap(2)**2-alfa**2)+h*alfa*sqrt(kappa(1)**2-alfa**2)-R*alfa*sind(psi)*sqrt(kappa(1)**2-alfa**2)
                DEtaPS = DEtaPS + R*cosd(psi)*sqrt(kappaCap(2)**2-alfa**2)*sqrt(kappa(1)**2-alfa**2)
        END FUNCTION DEtaPS
        ...
        FUNCTION D2EtaPS(alfa, h, R, kappa, kappaCap, psi)
            ...
            real*8  D2EtaPS, den1, den2
                ...
                den2 = sqrt(kappa(1)**2-alfa**2)**3
                D2EtaPS = kappaCap(2)**2*sind(psi)/den1 - h/R*kappaCap(2)**2/den1 - h/R*kappa(1)**2/den2
